...
export function PlayerContextProvider({children}: PlayerContextProviderPropst){
    ...
    return(
        <PlayerContext.Provider value={{episodeList, currentEpisodeIndex, isPlaying ,play, togglePlay, setPlayinginState, playList, playNext, 
        playPrevious, hasNext, hasPrevious, isLooping, toggleLoop, isShuffle, toggleShuffle, clearPlayerState}}>
            {children}
